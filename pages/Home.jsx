...
//         }}>
//           <img src="src\assets\Logo.jpeg" alt="Logo" style={{ width: 32, height: 32, objectFit:'contain',display:'block',borderRadius:'50%' }} />
//         </a>
...
//           <a className="btn btn-outline" href="/signup" style={{
...
//           <a className="btn btn-outline" href="/login" style={{
...
// function PostCard({ post, avatarUrl }) {
//   const navigate = useNavigate();
...
//             <span title="Updates">🔄 {post.updates}</span>
...
//       background: `linear-gradient(90deg,rgba(40,40,80,0.40),rgba(20,20,50,0.22)),
...
//       textShadow: "0 1px 7px rgba(0,0,0,0.16)"
...
//         background: "linear-gradient(90deg,#667eea 0%, #536895 100%)",

//         color: "white",

//         padding: "0.74rem 2.12rem",
...
//               <a href="/signup" style={{ marginLeft: '0.75rem', fontWeight: 500, fontSize: '1rem', color: '#764ba2' }}>Sign up</a> for unlimited access.
...
//               <PostCard post={post} avatarUrl={fallbackAvatars[ix % fallbackAvatars.length]} />
...
//         <button
//           className="btn"
//           style={{ background: 'white', color: '#333', marginTop: '1rem' }}
